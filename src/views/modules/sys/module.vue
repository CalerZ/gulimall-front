  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:module:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
          ...
          this.$http({
            ...
            if (data && data.code === 0) {
              this.$message({
                ...
                duration: 1500,
                onClose: () => {
                  if(data.data.list.length==0){this.this.getDeleteDataList()}else{
                    this.getDataList()
                  }
                }
              })
